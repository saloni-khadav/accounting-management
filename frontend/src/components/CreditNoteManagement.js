      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-[1600px] mx-auto">
            ...
            <div className="bg-gradient-to-r from-blue-300 to-blue-400 text-white p-6 rounded-t-xl">
              <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
                <div>
                  ...
                  <p className="text-blue-100 mt-1">Manage credit notes and returns</p>
                </div>
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <button
                    onClick={handleExportToExcel}
                    className="bg-white/20 backdrop-blur-sm text-white px-4 py-2 rounded-lg hover:bg-white/30 transition-colors flex items-center justify-center"
                  >
                  ...
                  <button
                    ...
                    className="bg-white text-blue-600 px-4 py-2 rounded-lg hover:bg-blue-50 transition-colors flex items-center justify-center font-medium"
                  >
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
          <div className="bg-gradient-to-r from-blue-300 to-blue-400 px-6 py-4 border-b border-blue-400">
            <h3 className="text-lg font-semibold text-white">Credit Notes</h3>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="text-left p-4 font-semibold text-gray-700 text-sm">Credit Note No.</th>
                  ...
                  <th className="text-left p-4 font-semibold text-gray-700 text-sm">Original Invoice</th>
                  <th className="text-left p-4 font-semibold text-gray-700 text-sm">Amount</th>
                  <th className="text-left p-4 font-semibold text-gray-700 text-sm">Approval</th>
                  ...
                  <tr>
                    <td colSpan="7" className="p-12 text-center text-gray-500">
                      ...
                      <p className="text-gray-600">
                        {creditNotes.length === 0 ? 'Create your first credit note to get started.' : 'Try adjusting your search criteria.'}
                      </p>
                    </td>
                  </tr>
                ) : (

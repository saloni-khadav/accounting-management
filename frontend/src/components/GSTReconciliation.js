      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-[1600px] mx-auto">
        ...
        <div className="mb-6 sm:mb-8 lg:mb-10">
          <div className="bg-gradient-to-r from-blue-300 to-blue-400 rounded-lg px-4 sm:px-6 py-3 sm:py-4">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2 sm:mb-3">GST Reconciliation</h1>
            <p className="text-white text-sm sm:text-base">Monitor GST compliance and reconciliation status</p>
          </div>
        </div>

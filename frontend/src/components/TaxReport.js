      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-[1600px] mx-auto">
        ...
        <div className="mb-6 sm:mb-8 lg:mb-10">
          <div className="bg-gradient-to-r from-blue-300 to-blue-400 rounded-lg px-4 sm:px-6 py-3 sm:py-4">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2 sm:mb-3">Tax Report</h1>
            <p className="text-white text-sm sm:text-base">Comprehensive tax summary and analysis</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 mb-6 sm:mb-8 lg:mb-10">
          <div className="relative bg-gradient-to-br from-white to-blue-50/30 rounded-2xl border border-blue-100 p-5 sm:p-6 hover:shadow-2xl hover:border-blue-300 transition-all duration-300 overflow-hidden group min-h-[130px]">
            ...
            <div className="ml-2">
              ...
              <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Total GST</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-700 truncate">₹{taxData?.totalGST?.toLocaleString('en-IN') || '0'}</p>
              </div>
            </div>
          </div>
          <div className="relative bg-gradient-to-br from-white to-blue-50/30 rounded-2xl border border-blue-100 p-5 sm:p-6 hover:shadow-2xl hover:border-blue-300 transition-all duration-300 overflow-hidden group min-h-[130px]">
            ...
            <div className="ml-2">
              ...
              <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Total GSTR1</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-700 truncate">₹{taxData?.gstr1AccountReceivable?.toLocaleString('en-IN') || '0'}</p>
              </div>
            </div>
          </div>
          <div className="relative bg-gradient-to-br from-white to-blue-50/30 rounded-2xl border border-blue-100 p-5 sm:p-6 hover:shadow-2xl hover:border-blue-300 transition-all duration-300 overflow-hidden group min-h-[130px]">
            ...
            <div className="ml-2">
              ...
              <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Total GSTR2B</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-700 truncate">₹{taxData?.gstr2b?.toLocaleString('en-IN') || '0'}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mb-6 sm:mb-8 lg:mb-10">
          <div className="relative bg-gradient-to-br from-white to-blue-50/30 rounded-2xl border border-blue-100 p-5 sm:p-6 hover:shadow-2xl hover:border-blue-300 transition-all duration-300 overflow-hidden group min-h-[130px]">
            ...
            <div className="ml-2">
              ...
              <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Mismatched Amount</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-700 truncate">₹{taxData?.mismatchedAmount?.toLocaleString('en-IN') || '0'}</p>
              </div>
            </div>
          </div>
          <div className="relative bg-gradient-to-br from-white to-blue-50/30 rounded-2xl border border-blue-100 p-5 sm:p-6 hover:shadow-2xl hover:border-blue-300 transition-all duration-300 overflow-hidden group min-h-[130px]">
            ...
            <div className="ml-2">
              ...
              <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Total TDS Payable</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-700 truncate">₹{taxData?.totalTDSPayable?.toLocaleString('en-IN') || '0'}</p>
              </div>
            </div>
          </div>
          <div className="relative bg-gradient-to-br from-white to-blue-50/30 rounded-2xl border border-blue-100 p-5 sm:p-6 hover:shadow-2xl hover:border-blue-300 transition-all duration-300 overflow-hidden group min-h-[130px]">
            ...
            <div className="ml-2">
              ...
              <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Total TDS Received</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-700 truncate">₹{taxData?.totalTDSReceived?.toLocaleString('en-IN') || '0'}</p>
              </div>
            </div>
          </div>
          <div className="relative bg-gradient-to-br from-white to-blue-50/30 rounded-2xl border border-blue-100 p-5 sm:p-6 hover:shadow-2xl hover:border-blue-300 transition-all duration-300 overflow-hidden group min-h-[130px]">
            ...
            <div className="ml-2">
              ...
              <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Total TDS Receivable</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-700 truncate">₹{taxData?.totalTDSReceivable?.toLocaleString('en-IN') || '0'}</p>
              </div>
            </div>
          </div>
        </div>

...
import { Plus, Search, Eye, Edit, Trash2, Download, Filter, FileText } from 'lucide-react';
...
const InvoiceManagement = ({ setActivePage }) => {
  ...
  const handleDownloadExcel = (invoice) => {
    const exportData = [{
      ...
      'Reference Number': invoice.referenceNumber || 'N/A',
    ...
    exportToExcel(exportData, `Invoice_${invoice.invoiceNumber}_${new Date().toISOString().split('T')[0]}`);
  };
                  ...
                  <td className="px-4 py-3 border-b text-sm">
                    <div className="flex gap-2">
                      ...
                      <button 
                        ...
                        className="bg-green-100 text-green-700 px-3 py-1 rounded text-xs hover:bg-green-200 flex items-center gap-1"
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <div className="mt-6 flex gap-3 justify-end">
                <button
                  onClick={() => handleDownloadExcel(viewingInvoice)}

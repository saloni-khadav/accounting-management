            ...
            {loading ? (
              ...
              filteredVendors.map((vendor) => (
                <tr key={vendor._id} className="hover:bg-gray-50">
                  <td className="px-4 py-3 border-b text-sm text-gray-700">{vendor.vendorName || 'N/A'}</td>
                  <td className="px-4 py-3 border-b text-sm text-gray-700">{vendor.vendorCode || 'N/A'}</td>
                  <td className="px-4 py-3 border-b text-sm text-gray-700">{vendor.contactPerson || 'N/A'}</td>
                  <td className="px-4 py-3 border-b text-sm text-gray-700">{vendor.email || 'N/A'}</td>
